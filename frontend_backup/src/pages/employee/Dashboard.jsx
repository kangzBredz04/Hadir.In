...
/**
 * Placeholder — dashboard employee lengkap dibangun di Tahap 3.
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-3 bg-background px-4 text-center">
      <span className="text-caption rounded-full bg-primary-light px-3 py-1 font-medium text-primary-dark">
        Employee Dashboard — dibangun penuh di Tahap 3
      </span>
      <h1 className="text-heading">Selamat datang, {user?.name ?? 'Karyawan'} 👋</h1>
